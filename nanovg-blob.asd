(asdf:defsystem nanovg-blob
  ...
  :libraries (((:darwin :x86-64 (:not :bodge-gl2))
              ...
              ((:unix (:not :darwin) :ppc64 :big-endian (:not :bodge-gl2))
               "libnanovg.so.gl3.bodged" "ppc64/")
              ((:unix (:not :darwin) :ppc64 :little-endian (:not :bodge-gl2))
               "libnanovg.so.gl3.bodged" "ppc64le/")
              ...
              ((:unix (:not :darwin) :ppc64 :big-endian :bodge-gl2)
               "libnanovg.so.gl2.bodged" "ppc64/")
              ((:unix (:not :darwin) :ppc64 :little-endian :bodge-gl2)
               "libnanovg.so.gl2.bodged" "ppc64le/")
